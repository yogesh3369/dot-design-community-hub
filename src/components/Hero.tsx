...
const Hero = () => {
  ...
  return <section className="relative pt-20 pb-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-lbd-dark z-0">
        ...
        <div className="absolute bottom-1/3 right-1/4 w-72 h-72 bg-purple-700 rounded-full filter blur-[120px] opacity-10 animate-pulse" style={{ animationDelay: "1s" }}></div>
        <div className="absolute -bottom-32 left-1/2 transform -translate-x-1/2 w-[800px] h-64 bg-lbd-pink rounded-full filter blur-[100px] opacity-5 animate-pulse" style={{ animationDuration: "8s" }}></div>
      </div>

      <div className="container-custom relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-heading mb-6 leading-tight animate-fade-in">
            From AI <span className="text-lbd-pink animate-pulse">Curiosity</span> to Design <span className="text-lbd-pink animate-pulse" style={{ animationDelay: "0.5s" }}>Confidence</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-lbd-white/80 mb-10 leading-relaxed animate-fade-in" style={{ animationDelay: "0.3s" }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            ...
            <Button variant="outline" className="border-lbd-white/30 text-lbd-white hover:bg-lbd-white/10 w-full sm:w-auto group">
              <Play className="mr-2 h-4 w-4 text-lbd-pink group-hover:scale-110 transition-transform" />
              Watch Demo
            </Button>
          </div>
          
          <div className="mt-16 flex flex-wrap items-center justify-center gap-8 md:gap-12 animate-fade-in" style={{ animationDelay: "0.9s" }}>
          ...
          <div className="mt-20 flex justify-center animate-bounce animate-fade-in" style={{ animationDelay: "1.2s" }}>
